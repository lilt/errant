...
from tagger.SCRDRLearnerNode import Node as Node
from tagger.SCRDRLearnerObject import FWObject as FWObject
...
class SCRDRTree:
    ...
    def writeToFileWithSeenCases(self, outFile):
        out = open(outFile, "w")
        self.root.write_to_file_with_seen_cases(out, 0)
        out.close()

    def writeToFile(self, outFile):
        out = open(outFile, "w")
        self.root.write_to_file(out, 0)
        out.close()
